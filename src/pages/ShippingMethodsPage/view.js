...
const setCurrentCrumb = '1';
const setPage = 'shipping';

const ShippingMethodsPage = Form.create()(observer((props) => { 
                ...
                <Row type="flex" justify="end" className="fullHeight">
                    <Col xs={24} md={24} lg={22} xl={17} className="fullHeight">
                        <Col xs={24} md={24} lg={23} xl={22} className="fullHeight">
                            <div className="shippingMethod fullHeight">
                                <div className="desktopView">
                                    <LogoHeader/>
                                    <Breadcrumb crumb={setCurrentCrumb}/>
                                </div>
                                <div className="shippingContent main">
                                    <ShippingMethod form={props.form}/>
                                </div>
                                <PaymentFooter/>
                            </div>
                        </Col>
